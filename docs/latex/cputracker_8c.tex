...
Definition at line \mbox{\hyperlink{cputracker_8c_source_l00125}{125}} of file \mbox{\hyperlink{cputracker_8c_source}{cputracker.\+c}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00125\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00126\ \ \ \textcolor{keyword}{struct\ }sigaction\ action;}
\DoxyCodeLine{00127\ \ \ memset(\&action,\ 0,\ \textcolor{keyword}{sizeof}(\textcolor{keyword}{struct}\ sigaction));}
\DoxyCodeLine{00128\ }
\DoxyCodeLine{00129\ \ \ \textcolor{keywordflow}{if}\ (get\_nproc(\&g\_nproc)\ ==\ -\/1)\ \{}
\DoxyCodeLine{00130\ \ \ \ \ exit(EXIT\_FAILURE);}
\DoxyCodeLine{00131\ \ \ \}}
\DoxyCodeLine{00132\ \ \ g\_nproc++;}
\DoxyCodeLine{00133\ }
\DoxyCodeLine{00134\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ BUFFER\_SIZE;\ i++)\ \{}
\DoxyCodeLine{00135\ \ \ \ \ g\_dataBuffer[i]\ =\ malloc((\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long})g\_nproc\ *\ \textcolor{keyword}{sizeof}(\textcolor{keyword}{struct}\ \mbox{\hyperlink{structproc__stat}{proc\_stat}}));}
\DoxyCodeLine{00136\ \ \ \ \ g\_printBuffer[i]\ =\ malloc((\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long})g\_nproc\ *\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{long}));}
\DoxyCodeLine{00137\ \ \ \ \ \textcolor{keywordflow}{if}\ (g\_dataBuffer[i]\ ==\ NULL\ ||\ g\_printBuffer[i]\ ==\ NULL)\ \{}
\DoxyCodeLine{00138\ \ \ \ \ \ \ exit(EXIT\_FAILURE);}
\DoxyCodeLine{00139\ \ \ \ \ \}}
\DoxyCodeLine{00140\ \ \ \}}
\DoxyCodeLine{00141\ }
\DoxyCodeLine{00142\ \ \ \textcolor{keywordflow}{if}\ (sem\_init(\&g\_dataFilledSpaceSemaphore,\ 0,\ 0)\ ||}
\DoxyCodeLine{00143\ \ \ \ \ \ \ sem\_init(\&g\_dataLeftSpaceSemaphore,\ 0,\ BUFFER\_SIZE))\ \{}
\DoxyCodeLine{00144\ \ \ \ \ exit(EXIT\_FAILURE);}
\DoxyCodeLine{00145\ \ \ \}}
\DoxyCodeLine{00146\ }
\DoxyCodeLine{00147\ \ \ \textcolor{keywordflow}{if}\ (sem\_init(\&g\_printFilledSpaceSemaphore,\ 0,\ 0)\ ||}
\DoxyCodeLine{00148\ \ \ \ \ \ \ sem\_init(\&g\_printLeftSpaceSemaphore,\ 0,\ BUFFER\_SIZE))\ \{}
\DoxyCodeLine{00149\ \ \ \ \ exit(EXIT\_FAILURE);}
\DoxyCodeLine{00150\ \ \ \}}
\DoxyCodeLine{00151\ }
\DoxyCodeLine{00152\ \ \ pthread\_create(\&readerThreadId,\ NULL,\ reader,\ NULL);}
\DoxyCodeLine{00153\ \ \ pthread\_create(\&analyzerThreadId,\ NULL,\ analyzer,\ NULL);}
\DoxyCodeLine{00154\ \ \ pthread\_create(\&printerThreadId,\ NULL,\ printer,\ NULL);}
\DoxyCodeLine{00155\ }
\DoxyCodeLine{00156\ \ \ action.sa\_handler\ =\ handler;}
\DoxyCodeLine{00157\ \ \ sigaction(SIGTERM,\ \&action,\ NULL);}
\DoxyCodeLine{00158\ }
\DoxyCodeLine{00159\ \ \ watchdog();}
\DoxyCodeLine{00160\ }
\DoxyCodeLine{00161\ \ \ pthread\_join(readerThreadId,\ NULL);}
\DoxyCodeLine{00162\ \ \ pthread\_join(analyzerThreadId,\ NULL);}
\DoxyCodeLine{00163\ \ \ pthread\_join(printerThreadId,\ NULL);}
\DoxyCodeLine{00164\ }
\DoxyCodeLine{00165\ \ \ pthread\_mutex\_destroy(\&g\_dataBufferMutex);}
\DoxyCodeLine{00166\ \ \ sem\_destroy(\&g\_dataFilledSpaceSemaphore);}
\DoxyCodeLine{00167\ \ \ sem\_destroy(\&g\_dataLeftSpaceSemaphore);}
\DoxyCodeLine{00168\ }
\DoxyCodeLine{00169\ \ \ pthread\_mutex\_destroy(\&g\_printBufferMutex);}
\DoxyCodeLine{00170\ \ \ sem\_destroy(\&g\_printFilledSpaceSemaphore);}
\DoxyCodeLine{00171\ \ \ sem\_destroy(\&g\_printLeftSpaceSemaphore);}
\DoxyCodeLine{00172\ }
\DoxyCodeLine{00173\ \ \ pthread\_mutex\_destroy(\&watchdogMutex);}
\DoxyCodeLine{00174\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ BUFFER\_SIZE;\ i++)\ \{}
\DoxyCodeLine{00175\ \ \ \ \ free(g\_dataBuffer[i]);}
\DoxyCodeLine{00176\ \ \ \ \ free(g\_printBuffer[i]);}
\DoxyCodeLine{00177\ \ \ \}}
