...
\DoxyCodeLine{\Hypertarget{reader_8c_source_l00033}00033\ \ \ \ \ notify\_watchdog(Reader);}
...
\DoxyCodeLine{\Hypertarget{reader_8c_source_l00037}00037\ \ \ \ \ \textcolor{keywordflow}{if}\ (get\_proc\_stats(get\_item\_from\_data\_buffer(),\ g\_nproc)\ ==\ -\/1)\ \{}
